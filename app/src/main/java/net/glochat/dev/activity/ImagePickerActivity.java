...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    private int ASPECT_RATIO_X = 16, ASPECT_RATIO_Y = 9, bitmapMaxWidth = 100, bitmapMaxHeight = 100;
    ...
    public static void showImagePickerOptions(Context context, ImagePickerActivity.PickerOptionListener listener) {
        // setup the alert builder
        AlertDialog.Builder builder = new AlertDialog.Builder(context, R.style.Theme_AppCompat_Dialog_Alert);
        builder.setTitle("UserData Profile Image");
                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport report) {
                        if (report.areAllPermissionsGranted()) {
                            ...
                            takePictureIntent.putExtra(MediaStore.EXTRA_SCREEN_ORIENTATION, ExifInterface.ORIENTATION_ROTATE_90);
