...
import net.glochat.dev.utils.NumUtils;
...
public class ControllerView extends RelativeLayout implements View.OnClickListener {
   ...
   // ImageView ivRecord;
    ...
    public void setVideoData(VideoBe videoData) {
        ...
        if (videoData.isLiked()) {
           ivLike.setTextColor(getResources().getColor(R.color.color_FF0041, null));
        } else {
            ivLike.setTextColor(getResources().getColor(R.color.white, null));
        }
